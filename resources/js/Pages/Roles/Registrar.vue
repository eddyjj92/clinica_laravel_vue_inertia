            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><i class="bi bi-shield-plus"></i> Registrar Rol de Usuario</h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active fw-bold"><i class="bi bi-shield-plus"></i>Registrar Rol de Usuario</li>
                                </ol>
                            </div>
                            <div class="card-body">
                                <form @submit.prevent="submit">
                                    <div class="row align-items-center justify-content-center mb-4">
                                        <div class="form-floating col-md-12 mb-4">
                                            <el-input v-model="form.nombre" type="text" size="large" class="extra-large" id="floatingInput2" placeholder="Nombre del Nuevo Rol"/>
                                        </div>
