        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a v-if="$page.props.auth.user !== null" :hidden="$page.props.auth.user.roles[0].permissions.filter(perm => perm.id === 1).length === 0" class="nav-link collapsed ripple" href="#" data-bs-toggle="collapse" data-bs-target="#collapseRoles" aria-expanded="false" aria-controls="collapseRoles">
                    ...
                    <a v-if="$page.props.auth.user !== null" :hidden="$page.props.auth.user.roles[0].permissions.filter(perm => perm.id === 5).length === 0" class="nav-link collapsed ripple" href="#" data-bs-toggle="collapse" data-bs-target="#collapseUsuarios" aria-expanded="false" aria-controls="collapseUsuarios">
                    ...
                    <a v-if="$page.props.auth.user !== null" :hidden="$page.props.auth.user.roles[0].permissions.filter(perm => perm.id === 9).length === 0" class="nav-link collapsed ripple" href="#" data-bs-toggle="collapse" data-bs-target="#collapseServidores" aria-expanded="false" aria-controls="collapseServidores">
